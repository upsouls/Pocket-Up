...
mainGroup.iscg = true
mainGroup.xScale, mainGroup.yScale = 1, 1.087323943662
...
local listImages = {1}
local listNamesImages = {'Фон'}
local listSounds = {}
tableFeathers = {}
tableFeathersOptions = {3.5, 0, 0, 255}


local object_1 = display.newImage('project_1/scene_1/object_1/image_1.png', system.DocumentsDirectory)
object_1.image_path = 'project_1/scene_1/object_1/image_1.png'
object_1.timers = {}
object_1.infoSaveVisPos = 1

local objectsTable = plugins.json.decode(funsP['получить сохранение']('project_1/scene_1/objects'))
objectsTable[object_1.infoSaveVisPos][3] = nil
funsP['записать сохранение']('project_1/scene_1/objects', plugins.json.encode(objectsTable))
cameraGroup:insert(object_1)
object_1.touchesObjects = {}
local background = object_1
background.listImagesBack, background.listNamesImagesBack, background.obj_pathBack = listImages, listNamesImages, 'project_1/scene_1/object_1'
...
local objectsParticles = {}
local listImages = {2}
local listNamesImages = {'Облака'}
local listSounds = {}
tableFeathers = {}
tableFeathersOptions = {3.5, 0, 0, 255}


local object_2 = display.newImage('project_1/scene_1/object_2/image_2.png', system.DocumentsDirectory)
object_2.image_path = 'project_1/scene_1/object_2/image_2.png'
object_2.timers = {}
...
pcall(function()
transition.to(target, {time=(5)*1000,
        x=( - 720), y= -(0)})
end)
threadFun.wait((5)*1000)
...
pcall(function()
transition.to(target, {time=(10)*1000,
        x=( - 720), y= -(0)})
end)
threadFun.wait((10)*1000)
...
local object_3 = display.newImage('project_1/scene_1/object_3/image_3.png', system.DocumentsDirectory)
object_3.image_path = 'project_1/scene_1/object_3/image_3.png'
object_3.timers = {}
object_3.infoSaveVisPos = 3
...
local objectsParticles = {}
local listImages = {4,5}
local listNamesImages = {'Крылья вверх','Крылья вниз'}
local listSounds = {}
tableFeathers = {}
tableFeathersOptions = {3.5, 0, 0, 255}


local object_4 = display.newImage('project_1/scene_1/object_4/image_4.png', system.DocumentsDirectory)
object_4.image_path = 'project_1/scene_1/object_4/image_4.png'
object_4.timers = {}
object_4.infoSaveVisPos = 4
...
pcall(function()
transition.to(target, {time=(1)*1000,
        x=( math.random  (  - 300 , 300 ) ), y= -( math.random  (  - 200 , 200 ) )})
end)
threadFun.wait((1)*1000)
...
threadFun.wait((0.2)*1000)



pcall(function()
target.numberImage = target.numberImage==#listImages and 1 or target.numberImage+1
target.image_path='project_1/scene_1/object_4/image_'..listImages[target.numberImage]..'.png'
target.fill = {type = 'image', filename = 'project_1/scene_1/object_4/image_'..listImages[target.numberImage]..'.png', baseDir = system.DocumentsDirectory}
