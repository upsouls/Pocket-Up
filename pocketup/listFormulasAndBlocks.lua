...
allBlocks = {
	...
	--["ask"]={"block", "blocks/block_green_3.png", { {{"text",words[160]},{"cell",nil,4.5}}, {{"text",words[162]}}, {{"variables",nil}} }, 109,188, false},
	...
	["lua"]={"block", "blocks/block_orange_2.png",  {{{"text", words[387]}}, {{"cell", nil, 8}}}, 109, 142, false},
	...
	["setBackgroundColor"]={"block", "blocks/block_green_3.png",  { {{"text", words[447]}}, {{"text", words[448]..':'}, {"cell", nil, 1}}, { {"text", words[449]..':'}, {"cell", nil, 1},  {"text", words[450]..':'}, {"cell", nil, 1 } }}, 109, 188, false},
}