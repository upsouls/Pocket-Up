...
"Копировано <count> актеров или объектов"--[[20]],"Удален <count> актер или объект","Удалено <count> актеров или объектов","Группа","Новая группа","Название группы"--[[25]],"Новая сцена",
 ...
 ,"ДА", "При старте", "Поместить в", "X","Y"--[[60]], "Вечно", "Конец (вечно)", "Скользить","секунд", "по X"--[[65]], "Категории", "Недавно добавленные","Событие","Управление",
 "Физика"--[[70]],"Звуки","Образы","Перо","Данные","Устройство"--[[75]],"При нажатии на объект", "При прикосновении к экрану","Когда будет получен сигнал","Новый сигнал","Вещать всем"--[[80]],
 ...
 "Клонировать","этот актер или объект"--[[90]],"Удалить этот клон","Ждать (beta)","секунд","Примечание","Новое примечание"--[[95]], "Если","истина, то","Иначе","Конец (если)",
 ...
 "в"--[[110]],"Продолжить сцену","Запустить сцену","Остановить этот скрипт","",""--[[115]],"","Ждать остановки всех других...","Установить X в",
...
"Конец (ждать)", "Задать цвет фона", "Красный", "Зелёный", "Синий", "HEX Цвет", "Отменить все таймеры", "Вызвать сообщение", "С текстом", "Показать хитбоксы"--[[455]], "Спрятать хитбоксы",
"Задать ландшафтную ориентацию","Задать портретную ориентацию","При отпускании от объекта","При перемещении по объекту"--[[460]],"При перемещении по экрану","При отпускании от экрана",
"При нажатии на кнопку назад","После столкновения с", "Задать грубость тела на",--[[465]]"Прыгнуть по Y на","Прыгнуть по X","Прыгнуть по Y","если","объект касается поверхности"--[[470]],
"Установить объекту масштаб","гравитации","Задать точку привязки переменной","Переместить переменную","на передний план"--[[475]],"на задний план","ширина экрана","высота экрана",
"актуальная ширина экрана","актуальная высота экрана"--[[480]],"Убрать адаптацию под экраны","список в json","json в список","Позиция X камеры","Позиция Y камеры", "Готовые образы"--[[486]]}--[[486]]
