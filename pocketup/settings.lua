...
"При нажатии на кнопку назад","После столкновения с", "Задать грубость тела на",--[[465]]"Прыгнуть по Y на","Прыгнуть по X","Прыгнуть по Y","если","объект касается поверхнсти"--[[470]],"Установить объекту масштаб","гравитации"}--[[472]]
