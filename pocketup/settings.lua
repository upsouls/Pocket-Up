...
"актуальная ширина экрана","актуальная высота экрана"--[[480]],"Убрать адаптацию под экраны","список в json","json в список","Позиция X камеры","Позиция Y камеры", "Добавить из медиатеки"--[[486]]}--[[486]]
